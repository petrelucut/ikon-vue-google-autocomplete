...
exports.default = {
    ...
    methods: {
       ...
       */
        createGoogleUrl() {
          var url = process.env.GOOGLE_MAPS.URL;

          if (process.env.GOOGLE_MAPS.api_key) {
            url += '?key=' + process.env.GOOGLE_MAPS.api_key;
          }

          if (process.env.GOOGLE_MAPS.libraries) {
            url += '&libraries=' + process.env.GOOGLE_MAPS.libraries;
          }
